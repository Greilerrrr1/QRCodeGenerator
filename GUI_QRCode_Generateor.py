...
def generate_qr():
    ...
    qr_img = qr.make_image(fill_color=fill_color.get(),
...
tk.Button(root, text="Pick Fill Color",
          command=lambda: choose_color(fill_color)).pack(pady=2)
tk.Button(root, text="Pick Background Color",
          command=lambda: choose_color(back_color)).pack(pady=2)
tk.Button(root, text="Choose Logo (optional)",
